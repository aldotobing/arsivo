            ...
            <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Laporan:</h6>
                        ...
                        <a class="collapse-item active" href="<?php URL::to('/'); ?>lappembelian">Order Kerja</a>
                </div>
            </div>
        </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Laporan Order Kerja</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <table border="0">
                            ...
                            <tr>
                                <td><label for="message-text" class="col-form-label">Jenis Order :</label></td>
                                <td>
                            ...
                            <tr>
                                <td><label for="message-text" class="col-form-label">Nama Customer :</label></td>
                                <td>
                                    <input type="text" class="form-control form-control-sm-custom" id="txt_nama_customer" autocompvare="off">
                                </td>
                            </tr>
                        </table><br>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                    ...
                                    <tbody id="tableBody_ReportPembelian"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $('#export_pdf').click(function(e){
            ...
            if(validasi == 0){
                ...
                var jenis_order             = $('#txt_jenis_pembelian').val();
                var nama_customer           = $('#txt_nama_customer').val();
                
                var url = "<?php URL::to('/'); ?>export_lap_pembelian_pdf?tgl_awal="+start_tgl_penawaran+"&tgl_akhir="+end_tgl_penawaran+"&jenis_order="+jenis_order+"&nama_customer="+nama_customer;
        ...
        $('#export_excel').click(function(){
            ...
            window.open("{{ URL::to('/') }}/export_lap_pembelian?tgl_awal=" + start_tgl_penawaran + "&tgl_akhir=" + end_tgl_penawaran + "&jenis_order=" + jenis_order + "&nama_customer=" + nama_customer, '_blank');
        });
        ...
        $('#preview_laporan').click(function (e) {
            ...
            if (validasi === 0) {
                $.ajax({
                    url: "{{ url('/preview_lap_pembelian') }}", // pakai blade url
                    type: "GET",
                    data: {
                    ...
                    success: function (res) {
                        var tbody = $("#tableBody_ReportPembelian");
                            ...
                            $.each(res, function (i, item) {
                                var row = `
                                    <tr>
                                        ...
                                        <td align="right">${item.harga.toLocaleString('id-ID')}</td>
                                        <td align="right">${ ((item.qty ?? 0) * (item.harga ?? 0)).toLocaleString('id-ID') }</td>
                                    </tr>
                                `;
                                total += parseFloat(((item.qty ?? 0) * (item.harga ?? 0))) || 0;
                                tbody.append(row);
                            });
                            var row = `
                                    <tr>
                                        <td colspan="8" align="right">Total</td>
                                        <td align="right">${Number(total).toLocaleString("id-ID")}</td>
                                    </tr>
                                `;
                                tbody.append(row);
                        } else {
