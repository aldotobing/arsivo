            ...
            <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Laporan:</h6>
                        ...
                        <a class="collapse-item active" href="<?php URL::to('/'); ?>laprevenue">Revenue</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Laporan Revenue</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                    ...
                                    <tbody id="tableBody_ReportRevenue"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $('#export_pdf').click(function(e){
            ...
            if(validasi == 0){
                ...
                var url = "<?php URL::to('/'); ?>export_lap_revenue_pdf?tgl_awal="+start_tgl_penawaran+"&tgl_akhir="+end_tgl_penawaran + "&nama_customer=" + nama_customer;
        ...
        $('#export_excel').click(function(){
            ...
            window.open("{{ URL::to('/') }}/export_lap_revenue?tgl_awal=" + start_tgl_penawaran + "&tgl_akhir=" + end_tgl_penawaran + "&nama_customer=" + nama_customer, '_blank');
        });
        ...
        $('#preview_laporan').click(function (e) {
            ...
            if (validasi === 0) {
                $.ajax({
                    url: "{{ url('/preview_lap_revenue') }}", // pakai blade url
                    type: "GET",
                    data: {
                    ...
                    success: function (res) {
                        var tbody = $("#tableBody_ReportRevenue");
